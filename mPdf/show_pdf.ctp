...
foreach ( $quotation_details as $quotation_detail ) {
    ...
    $trs .="<tr>";
    $trs .="<td>".$sl++."</td>";
    $trs .="<td align='left'>". $quotation_detail['part_number']."</td>";
    $trs .="<td align='left'>".$quotation_detail['part_name']."</td>";
    $trs .="<td align='right'>".$quotation_detail['part_qty']."</td>";
    $trs .="<td align='right'>".number_format($quotation_detail['unit_price'],2)."</td>";
    $trs .="<td align='right'>".number_format($quotation_detail['total'],2)."</td>";
    $trs .="<td align='center'>".$quotation_detail['delivery']."</td>";
    $trs .="<td align='center'>".$quotation_detail['remarks']."</td>";
    $trs .="</tr>";
}
$html='<!DOCTYPE html>
<html lang="en">
    ...
    <header class="clearfix">
     ...
     <div class="company clearfix" style="width:50%;float:right;font-size:8pt;">
      ...
      <div class="project clearfix" style="height:80px; padding: 10px; margin-left: 15px; float: right; font-size: 8pt;border:1px solid #000">
         '.$quotation_master->reference_detail.'
      </div>
    </header>
    <main>   
   <table style="margin-top:10px">
      ...
      <div style="font-size:10pt">
          ...
          <div class="" style="padding: 0px; margin: 0px; float: right;">
             '.str_replace('<p>','',$quotation_master->offer_validity).'
          </div>
      </div>
      ...
      <div style="font-size:10pt;margin-top:5px;">
        <div class="" style="width: 20%;  padding: 0px; margin: 0px;float: left;">
          ...
          <div class="" style="padding: 0px; margin: 0px; float: right;">
             '.str_replace('<p>','',$quotation_master->payment_terms).'
          </div>
      </div>
      ...
      <div style="font-size:10pt;margin-top:15px;">
        <div class="" style="width: 20%;  padding: 0px; margin: 0px;float: left;">
          ...
          <div class="" style="padding: 0px; margin: 0px; float: right;">
             '.str_replace('<p>','',$quotation_master->note).'
          </div>
      </div>
